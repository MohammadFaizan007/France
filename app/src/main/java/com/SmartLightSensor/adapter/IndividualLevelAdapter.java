...
public class IndividualLevelAdapter extends BaseAdapter implements AdvertiseResultInterface, ReceiverResultInterface {
    Activity activity;
    ...
    public IndividualLevelAdapter(@NonNull Activity context) {
        activity = context;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) { {
        ...
        viewHolder.dashboardDeviceName.setText(deviceClass.getDeviceLevel());
...
//                        arrayList.get(position).setStatus(true);
                ...
                advertiseTask=new AdvertiseTask(IndividualLevelAdapter.this,activity,5*1000);
...
//            contentValues.put(COLUMN_DEVICE_PROGRESS,seekBarProgress[0]);
                ...
                IndividualLevelAdapter.this.seekBarProgress=seekBarProgress[0];
