...
import static com.SmartLightSensor.EncodeDecodeModule.RxMethodType.GROUP_STATE_COMMAND;
...
public class DashboardGroupAdapter extends BaseAdapter implements AdvertiseResultInterface, ReceiverResultInterface {
    Activity activity;
    ...
    public DashboardGroupAdapter(@NonNull Activity context) {
        activity = context;
...
//            arrayList.get(index).setGroupDimming(seekBarProgress);
                ...
                advertiseTask=new AdvertiseTask(DashboardGroupAdapter.this,activity,5*1000);
