...
import static com.SmartLightSensor.EncodeDecodeModule.ArrayUtilities.bytesToHex;
...
public class IndividualBuildingAdapter extends BaseAdapter implements AdvertiseResultInterface, ReceiverResultInterface {
    Activity activity;
    ...
    public IndividualBuildingAdapter(@NonNull Activity context) {
        activity = context;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) { {
        ...
        viewHolder.dashboardDeviceName.setText(deviceClass.getDeviceBuilding());
...
//
//        viewHolder.details.setOnClickListener(v -> {
//            Intent intent = new Intent(activity, HelperActivity.class);
...
//                        arrayList.get(position).setStatus(true);
                ...
                advertiseTask=new AdvertiseTask(IndividualBuildingAdapter.this,activity,5*1000);
...
//            contentValues.put(COLUMN_DEVICE_PROGRESS,seekBarProgress[0]);
                ...
                IndividualBuildingAdapter.this.seekBarProgress=seekBarProgress[0];
