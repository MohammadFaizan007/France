...
public class IndividualRoomAdapter extends BaseAdapter implements AdvertiseResultInterface, ReceiverResultInterface {
    Activity activity;
    ...
    public IndividualRoomAdapter(@NonNull Activity context) {
        activity = context;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) { {
        ...
        viewHolder.dashboardDeviceName.setText(deviceClass.getDeviceRoom());
...
//                        arrayList.get(position).setStatus(true);
                ...
                advertiseTask=new AdvertiseTask(IndividualRoomAdapter.this,activity,5*1000);
...
//            contentValues.put(COLUMN_DEVICE_PROGRESS,seekBarProgress[0]);
                ...
                IndividualRoomAdapter.this.seekBarProgress=seekBarProgress[0];
