...
public class IndividualSiteAdapter extends BaseAdapter implements AdvertiseResultInterface, ReceiverResultInterface {
    Activity activity;
    ...
    public IndividualSiteAdapter(@NonNull Activity context) {
        activity = context;
...
//                        arrayList.get(position).setStatus(true);
                ...
                advertiseTask=new AdvertiseTask(IndividualSiteAdapter.this,activity,5*1000);
...
//            contentValues.put(COLUMN_DEVICE_PROGRESS,seekBarProgress[0]);
                ...
                IndividualSiteAdapter.this.seekBarProgress=seekBarProgress[0];
